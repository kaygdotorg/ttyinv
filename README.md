...
It is intentionally **an invoice renderer, not an invoice-management system**. There is no web app, editor, login, database, customer directory, email delivery, payment collection, live exchange-rate lookup, or jurisdiction-aware tax engine.
