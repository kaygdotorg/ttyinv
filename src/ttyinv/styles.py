...
.document-section[data-page-break-before="true"], .footer-stack[data-page-break-before="true"] { break-before: page; page-break-before: always; }
.footer-stack[data-page-break-before="true"] { margin-top: 5mm; }
...
.document-section + .document-section:not([data-page-break-before="true"]) { margin-top: calc(var(--section-gap) + var(--section-gap-extra)); }
...
.section-tail, .grand-total, .footer-stack, .payment-frame, .signature { break-inside: avoid-page; page-break-inside: avoid; }
